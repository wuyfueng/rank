...
var (
	...
	rankConfMap = map[constants.RankType]*RankConf{
		constants.RankTypeScore: {rankType: constants.RankTypeScore, desc: "全服分数排行榜", name: "score", regionType: constants.RankRegionTypeGlobal, isHomePage: true, isPositiveSort: false, isTimeScore: false, isSyncIncr: false, isConcurrencySync: false, cacheUserNum: 100, rankingUserNum: 100, cacheDuration: constants.RankCacheDurationSize, isTimely: false},
	}
)
